<h2><a href="https://leetcode.com/problems/binary-watch/?envType=daily-question&envId=2026-02-17">19. Binary Watch</a></h2><h3>Easy</h3><hr><p>A binary watch has 4 LEDs on the top to represent the hours (0-11), and 6 LEDs on the bottom to represent&nbsp;the minutes (0-59). Each LED represents a zero or one, with the least significant bit on the right.</p>
